#pragma checksum "E:\Visual Studio 2017\Projects\UWP Complete Beginners\UWP-026\xBindDataExample\xBindDataExample\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "2A217B53994395329F8B7C4AB0C8D6F0"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace xBindDataExample
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj2_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::xBindDataExample.Models.Book dataRoot;
            ...
            {
                 global::xBindDataExample.Models.Book data = args.NewValue as global::xBindDataExample.Models.Book;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::xBindDataExample.Models.Book was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::xBindDataExample.Models.Book);
                ...
                this.Update_((global::xBindDataExample.Models.Book) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::xBindDataExample.Models.Book newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::xBindDataExample.Models.Book obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::xBindDataExample.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void SetDataRoot(global::xBindDataExample.MainPage newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::xBindDataExample.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Books(global::System.Collections.Generic.List<global::xBindDataExample.Models.Book> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 2:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::xBindDataExample.Models.Book) element2.DataContext);
